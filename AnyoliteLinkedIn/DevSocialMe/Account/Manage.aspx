<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="DevSocialMe.Account.Manage" %>
        ...
        <div class="span6">
            <section id="passwordForm">
                ...
                <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                    ...
                    <fieldset class="form-horizontal">
                        <legend>Change User Info Form</legend>
                        <div class="control-group">
                            <asp:Label runat="server" ID="LabelNewFullname" AssociatedControlID="NewFullname" CssClass="control-label">New Fullname</asp:Label>
                            <div class="controls">
                                <asp:TextBox runat="server" ID="NewFullname" Text="" />
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="NewFullname"
                                    CssClass="text-error" ErrorMessage="The current fullname field is required."
                                    ValidationGroup="ChangeUserinfo" />
                            </div>
                        </div>
                        <div class="control-group">
                            <asp:Label runat="server" ID="LabelNewEmail" AssociatedControlID="NewEmail" CssClass="control-label">New Email</asp:Label>
                            <div class="controls">
                                <asp:TextBox runat="server" ID="NewEmail" Text="" />
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="NewEmail"
                                    CssClass="text-error" ErrorMessage="The current Email field is required."
                                    ValidationGroup="ChangeUserinfo" />
                            </div>
                        </div>
                        <div class="control-group">
                            <asp:Label runat="server" ID="LabelNewSummary" AssociatedControlID="NewSummary" CssClass="control-label">New Summary</asp:Label>
                            <div class="controls">
                                <asp:TextBox TextMode="MultiLine" Rows="5" Columns="5" runat="server" ID="NewSummary" Text="" />
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="NewSummary"
                                    CssClass="text-error" ErrorMessage="The current Email field is required."
                                    ValidationGroup="ChangeUserinfo" />
                            </div>
                        </div>
                        <div class="form-actions no-color">
                            <asp:Button runat="server" Text="Change user info" OnClick="ChangeUserinfo_Click"
                                 CssClass="btn" ValidationGroup="ChangeUserinfo" />
                        </div>
                    </fieldset>
                </asp:PlaceHolder>
            </section>
