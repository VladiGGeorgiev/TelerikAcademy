...
namespace DevSocialMe.Account
{
    public partial class Manage : System.Web.UI.Page
    {
        ...
        protected void ChangeUserinfo_Click(object sender, EventArgs e)
        {
            if (IsValid)
            {
                ApplicationDbContext context = new ApplicationDbContext();
                var selectedUser = context.Users.FirstOrDefault(u => u.UserName == User.Identity.Name);
                selectedUser.FullName = this.NewFullname.Text;
                selectedUser.Email = this.NewEmail.Text;
                selectedUser.Summary = this.NewSummary.Text;
                context.SaveChanges();
            }
        }
