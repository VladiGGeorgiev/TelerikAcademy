...
namespace Giftable.Win8
{
    ...
    ///// </summary>
    public sealed partial class SplitPage : Giftable.Win8.Common.LayoutAwarePage
    {
        public SplitPage()
        {
    ...
    //    /// session.  This will be null the first time a page is visited.</param>
        ...
        {
            var user = navigationParameter as FriendModel;
            var splitPageViewModel = this.DataContext as SplitPageViewModel;
            if (splitPageViewModel != null)
            {
                splitPageViewModel.LoadData(user);
            }
        }
