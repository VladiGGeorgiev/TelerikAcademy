...
-- --------------------------------------------------
-- Date Created: 07/15/2013 18:20:37
-- Generated from EDMX file: D:\PROGRAMMING\CODES\Databases\EntityFramework\NorthwindEntity.Data\Northwind.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[NORTHWNDModelStoreContainer].[Alphabetical list of products]', 'U') IS NOT NULL
    DROP TABLE [NORTHWNDModelStoreContainer].[Alphabetical list of products];
GO
IF OBJECT_ID(N'[NORTHWNDModelStoreContainer].[Category Sales for 1997]', 'U') IS NOT NULL
    DROP TABLE [NORTHWNDModelStoreContainer].[Category Sales for 1997];
GO
IF OBJECT_ID(N'[NORTHWNDModelStoreContainer].[Current Product List]', 'U') IS NOT NULL
    DROP TABLE [NORTHWNDModelStoreContainer].[Current Product List];
GO
IF OBJECT_ID(N'[NORTHWNDModelStoreContainer].[Customer and Suppliers by City]', 'U') IS NOT NULL
    DROP TABLE [NORTHWNDModelStoreContainer].[Customer and Suppliers by City];
GO
IF OBJECT_ID(N'[NORTHWNDModelStoreContainer].[Invoices]', 'U') IS NOT NULL
    DROP TABLE [NORTHWNDModelStoreContainer].[Invoices];
GO
IF OBJECT_ID(N'[NORTHWNDModelStoreContainer].[Order Details Extended]', 'U') IS NOT NULL
    DROP TABLE [NORTHWNDModelStoreContainer].[Order Details Extended];
GO
IF OBJECT_ID(N'[NORTHWNDModelStoreContainer].[Order Subtotals]', 'U') IS NOT NULL
    DROP TABLE [NORTHWNDModelStoreContainer].[Order Subtotals];
GO
IF OBJECT_ID(N'[NORTHWNDModelStoreContainer].[Orders Qry]', 'U') IS NOT NULL
    DROP TABLE [NORTHWNDModelStoreContainer].[Orders Qry];
GO
IF OBJECT_ID(N'[NORTHWNDModelStoreContainer].[Product Sales for 1997]', 'U') IS NOT NULL
    DROP TABLE [NORTHWNDModelStoreContainer].[Product Sales for 1997];
GO
IF OBJECT_ID(N'[NORTHWNDModelStoreContainer].[Products Above Average Price]', 'U') IS NOT NULL
    DROP TABLE [NORTHWNDModelStoreContainer].[Products Above Average Price];
GO
IF OBJECT_ID(N'[NORTHWNDModelStoreContainer].[Products by Category]', 'U') IS NOT NULL
    DROP TABLE [NORTHWNDModelStoreContainer].[Products by Category];
GO
IF OBJECT_ID(N'[NORTHWNDModelStoreContainer].[Sales by Category]', 'U') IS NOT NULL
    DROP TABLE [NORTHWNDModelStoreContainer].[Sales by Category];
GO
IF OBJECT_ID(N'[NORTHWNDModelStoreContainer].[Sales Totals by Amount]', 'U') IS NOT NULL
    DROP TABLE [NORTHWNDModelStoreContainer].[Sales Totals by Amount];
GO
IF OBJECT_ID(N'[NORTHWNDModelStoreContainer].[Summary of Sales by Quarter]', 'U') IS NOT NULL
    DROP TABLE [NORTHWNDModelStoreContainer].[Summary of Sales by Quarter];
GO
IF OBJECT_ID(N'[NORTHWNDModelStoreContainer].[Summary of Sales by Year]', 'U') IS NOT NULL
    DROP TABLE [NORTHWNDModelStoreContainer].[Summary of Sales by Year];
GO
